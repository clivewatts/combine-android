...
public class AppDbHelper implements DbHelper {
    ...
    @Override
    public Observable<List<SteamGameCard>> getAllQuestions() {
        return Observable.fromCallable(new Callable<List<SteamGameCard>>() {
            @Override
            public List<SteamGameCard> call() throws Exception {
                return mDaoSession.getSteamGameCardDao().loadAll();
            }
        });
    }
    ...
    public Observable<Boolean> isQuestionEmpty() {
        return Observable.fromCallable(new Callable<Boolean>() {
            ...
            public Boolean call() throws Exception {
                return !(mDaoSession.getSteamGameCardDao().count() > 0);
            }
        });
    }
    ...
    @Override
    public Observable<Boolean> saveQuestion(final SteamGameCard steamGameCard) {
        return Observable.fromCallable(new Callable<Boolean>() {
            @Override
            public Boolean call() throws Exception {
                mDaoSession.getSteamGameCardDao().insert(steamGameCard);
                return true;
            }
        });
    }
    ...
    @Override
    public Observable<Boolean> saveQuestionList(final List<SteamGameCard> steamGameCardList) {
        return Observable.fromCallable(new Callable<Boolean>() {
            @Override
            public Boolean call() throws Exception {
                mDaoSession.getSteamGameCardDao().insertInTx(steamGameCardList);
                return true;
            }
        });
    }
