...
public class MainActivity extends BaseActivity implements MainMvpView {
    ...
    @Override
    public void refreshQuestionnaire(List<SteamGameCard> steamGameCardList) {
        for (SteamGameCard steamGameCard : steamGameCardList) {
            if (steamGameCard != null
                    && steamGameCard.getOptionList() != null
                    && steamGameCard.getOptionList().size() == 3) {
                QuestionCard c = new QuestionCard(steamGameCard,getApplicationContext());
                mCardsContainerView.addView(c);
            }
        }
    }

    @Override
    public void reloadQuestionnaire(List<SteamGameCard> steamGameCardList) {
        refreshQuestionnaire(steamGameCardList);
    ...
    private void setupCardContainerView() {
        ...
        mCardsContainerView.getBuilder()
                ...
                .setSwipeDecor(new SwipeDecor()
                        .setPaddingTop(0)
                        .setSwipeAnimFactor(20)
                        .setSwipeRotationAngle(40)
