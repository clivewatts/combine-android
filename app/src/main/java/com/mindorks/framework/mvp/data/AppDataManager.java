...
public class AppDataManager implements DataManager {
    ...
    @Override
    public Observable<Boolean> saveQuestion(SteamGameCard steamGameCard) {
        return mDbHelper.saveQuestion(steamGameCard);
    }
    ...
    @Override
    public Observable<Boolean> saveQuestionList(List<SteamGameCard> steamGameCardList) {
        return mDbHelper.saveQuestionList(steamGameCardList);
    }
                        ...
                        if (isEmpty) {
                            Type type = $Gson$Types
                                    .newParameterizedTypeWithOwner(null, List.class,
                                            SteamGameCard.class);
                            List<SteamGameCard> steamGameCardList = gson.fromJson(
                                    CommonUtils.loadJSONFromAsset(mContext,
                                            AppConstants.SEED_DATABASE_QUESTIONS),
                                    type);

                            return saveQuestionList(steamGameCardList);
                        }
