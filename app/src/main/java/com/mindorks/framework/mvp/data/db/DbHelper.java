...
public interface DbHelper {
    ...
    Observable<List<SteamGameCard>> getAllQuestions();

    Observable<Boolean> isQuestionEmpty();

    Observable<Boolean> isOptionEmpty();

    Observable<Boolean> saveQuestion(SteamGameCard steamGameCard);

    Observable<Boolean> saveOption(Option option);

    Observable<Boolean> saveQuestionList(List<SteamGameCard> steamGameCardList);
